        ...
        <form action="<?php $_SERVER['REQUEST_URI'] ?>" method="post">
            ...
            <table width="100%" cellspacing="2" cellpadding="5" class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="radio" id="link_flickr" name="<?php echo self::OPTION_PHOTO_LINK ?>" value="0" <?php if (0 == $wpFlickrEmbed->settings[self::OPTION_PHOTO_LINK]) { ?>checked="checked" <?php } ?>/> <label for="link_flickr"><?php _e('The photostream page of Flickr', $this->_slug); ?></label><br />
                        ...
                        <input type="radio" id="link_set" name="<?php echo self::OPTION_PHOTO_LINK ?>" value="3" <?php if (3 == $wpFlickrEmbed->settings[self::OPTION_PHOTO_LINK]) { ?>checked="checked" <?php } ?>/> <label for="link_set"><?php _e('The "set" (Album) page of Flickr', $this->_slug); ?></label><br />
                    </td>
                </tr>
                <tr>
